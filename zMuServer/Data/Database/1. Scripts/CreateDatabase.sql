...
IF (@Create_Me_MuOnlineDB = 1)
  BEGIN
	...
	(
		...
		FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Me_MuOnline_Data.MDF' , 
		SIZE = 5, FILEGROWTH = 10%
	) 
	LOG ON 
	(
		NAME = N'Me_MuOnline_Log', 
		FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Me_MuOnline_Log.LDF' , 
		SIZE = 5, FILEGROWTH = 10%
	)
...
(
	...
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\MuOnline_Data.MDF' , 
	SIZE = 5, FILEGROWTH = 10%
) 
LOG ON 
(
	NAME = N'MuOnline_Log', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\MuOnline_Log.LDF' , 
	SIZE = 5, FILEGROWTH = 10%
)
COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
(
	NAME = N'Events_Data', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Events_Data.MDF' , 
	SIZE = 5, FILEGROWTH = 10%
) 
LOG ON 
(
	NAME = N'Events_Log', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Events_Log.LDF' , 
	SIZE = 5, FILEGROWTH = 10%
)
COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
(
	NAME = N'Ranking_Data', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Ranking_Data.MDF' , 
	SIZE = 5, FILEGROWTH = 10%
) 
LOG ON 
(
	NAME = N'Ranking_Log', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\Ranking_Log.LDF' , 
	SIZE = 5, FILEGROWTH = 10%
)
COLLATE SQL_Latin1_General_CP1_CI_AS
GO
...
(
	...
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\BattleCore_Data.MDF' , 
	SIZE = 5, FILEGROWTH = 10%
) 
LOG ON 
(
	NAME = N'BattleCore_Log', 
	FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\<INSTANCE_NAME>\MSSQL\DATA\BattleCore_Log.LDF' , 
	SIZE = 5, FILEGROWTH = 10%
)
COLLATE SQL_Latin1_General_CP1_CI_AS
GO